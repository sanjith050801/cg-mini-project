...
float angle, p1 = 107.0, p2 = 300.0, p3 = 175.0, p4 = 200.0, p5 = 175.0, p6 = 200.0, p7 = 100.0, p8 = 115.0, p9 = 185.0, p10 = 99.0, p11 = 210.0, p12 = 280.0, p13 = 300.0, p14 = 262.0, p15 = 300.0, p16 = 114.0, p17 = 216.0, p18 = 99.0;
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Client-Server Networking Architecture");
	Init();
